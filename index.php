...
<!--Title -->
  ...
  <div class="row">
      <div class="col-lg-6" style="font-family: 'Montserrat';font-weight:900;" >
        ...
        <a href="download.php"><button type="button" class="btn btn-outline-primary btn-lg download-button"><i class="fab fa-apple"></i> Download</button></a>
        <a href="download.php"><button type="button" class="btn btn-outline-dark btn-lg download-button"><i class="fab fa-google-play"></i> Download</button></a>
